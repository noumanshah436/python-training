# Proxy pattern is similar to decortaor design pattern
# In proxy we are wrapping functionality around something, it wraps functionality around the object creation.
# Proxy uses additional layer of abstractoin or protection
